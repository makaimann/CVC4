...
#ifndef __CVC4__THEORY__MATRIX__THEORY_MATRIX_REWRITER_H
#define __CVC4__THEORY__MATRIX__THEORY_MATRIX_REWRITER_H
...
class TheoryMatrixRewriter {
public:

  /**
   * Rewrite a node into the normal form for the theory of matrix.
...
#endif /* __CVC4__THEORY__MATRIX__THEORY_MATRIX_REWRITER_H */
